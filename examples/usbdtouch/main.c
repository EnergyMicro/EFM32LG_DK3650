...
#define LCD_TOUCH_X1    gpioPortD,5
#define LCD_TOUCH_X2    gpioPortD,4         /* ADC0_Ch4 Loc 0 */
#define LCD_TOUCH_Y1    gpioPortD,3
#define LCD_TOUCH_Y2    gpioPortD,1         /* ADC0_Ch1 Loc 0 */
