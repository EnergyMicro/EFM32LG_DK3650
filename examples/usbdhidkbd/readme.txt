...
reflects the scan rate of the onebutton keypad. The scan rate will equal
the bInterval value of the IN interrupt endpoint (or a value set by your
hosts device driver if it wish to override the default bInterval).
